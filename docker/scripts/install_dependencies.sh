...
if [[ "$ID" == "debian" || "$ID" == "ubuntu" ]]; then
    bash "$script_dir/install_ubuntu_dependencies.sh" "$mode"
elif [[ "$ID" == "arch" ]]; then
    bash "$script_dir/install_arch_dependencies.sh" "$mode"
elif [[ "$ID" == "rhel" ]]; then
    bash "$script_dir/install_rhel_dependencies.sh" "$mode"
elif [[ "$ID" == "fedora" || "$ID" == "centos" ]]; then
    bash "$script_dir/install_fedora_dependencies.sh" "$mode"
else
